...
wget -q https://github.com/nwchemgit/nwchem/tarball/hotfix/release-7-3-0 -O nwchem_7.3.1.orig.tar.gz
#tar  --exclude=web --exclude=examples --exclude=doc  --exclude="nwxc*"  --exclude="chem-library-tests"  -xzf nwchem_7.2.3.orig.tar.gz
tar    -xzf nwchem_7.3.1.orig.tar.gz
mv nwchemgit-nwchem-* nwchem-7.3.1
cp -rp debian nwchem-*/.
cd nwchem-*
